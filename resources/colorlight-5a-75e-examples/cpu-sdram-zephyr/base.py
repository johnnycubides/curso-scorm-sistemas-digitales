...
_io = [
        ...
        ("pwm", 0, Pins("G2"), IOStandard("LVCMOS33")), # LED externo
    ]
...
class BaseSoC(SoCCore):
    def __init__(
        ...
        # PWM
        pwm = Cat(platform.request("pwm", 0))
...
def main():
    parser = argparse.ArgumentParser(
        description="LiteX SoC on Colorlight 5A-75E")
    builder_args(parser)
    ...
    parser.add_argument(
        "--board",
        default="5a-75e",
        help="Board type: 5a-75e")
    parser.add_argument(
        "--revision",
        default="7.1",
        type=str,
        help="Board revision 7.1")
    parser.add_argument(
        "--with-ethernet",
        action="store_true",
