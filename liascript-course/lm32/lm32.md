...
En la siguiente tabla, se puede observar los registros de estado y control (CSR), indicando si son de lectura o escritura y el índice que se utiliza para tenera aceeso al registro.
